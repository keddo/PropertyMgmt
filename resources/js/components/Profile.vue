                  ...
                  <div class="tab-pane active show" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea v-model="form.bio" :class="{ 'is-invalid': form.errors.has('bio') }" rows="8" class="form-control" name="experience" id="experience" placeholder="Experience"></textarea>
